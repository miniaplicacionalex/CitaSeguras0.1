      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {appointments.length === 0 ? (
            <div className="bg-white border border-dashed border-slate-200 rounded-2xl p-6 text-center space-y-3 shadow-xs">
              <span className="text-3xl block">📅</span>
              <p className="text-xs font-bold text-slate-700">Sin citas registradas aún</p>
              <p className="text-[10px] text-slate-400 leading-relaxed max-w-[280px] mx-auto">
                Las citas agendadas por tus clientes aparecerán aquí en tiempo real para verificar sus depósitos y gestionar recordatorios.
              </p>
            </div>
          ) : (
